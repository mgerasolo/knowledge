...
>>>>>>> origin/main
| 4 | 2026-08-13 | Publishing the consumer guide made the capability discoverable by other projects | The guide exists only in this repo — it was never submitted to the central guide registry, so no other project's delivered bundle includes it | Submit the guide through the central intake once current fixes land | OPEN |
